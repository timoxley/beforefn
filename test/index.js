...
test('inherit: function keys are copied across', function(t) {
  function Thing() {}
  Thing.copied = true
  var anotherThing = {}
  Thing.prototype = anotherThing

  var NewThing = before.inherit(Thing, function() {})
  t.ok(NewThing.copied)
  t.equal(NewThing.prototype, anotherThing)
  t.end()
})

test('inherit: function keys are available on fn.fn', function(t) {
  function Thing() {}
  Thing.copied = true
  var anotherThing = {}
  Thing.prototype = anotherThing

  before.inherit(Thing, function fn() {
    t.ok(fn.fn.copied)
